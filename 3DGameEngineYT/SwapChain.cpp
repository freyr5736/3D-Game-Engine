...
void SwapChain::resize(unsigned int width, unsigned height)
{
...
void SwapChain::setFullScreen(bool fullscreen, unsigned int width, unsigned height)
{
	resize(width, height);
...
void SwapChain::reloadBuffers(unsigned int width, unsigned height)
{
